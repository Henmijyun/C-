...
//	char arr2[] = "bbc";
//	char* ret = strstr(arr1, arr2);//查找子字符串
//	if (NULL == ret)
//		printf("找不到\n");
//	else
//		printf("找到了\n");
...
//int main()
//{
//	char arr[] = "bitepeng@qq.com";
//	char buf[30] = { 0 }; //strtok();会改变字符串内容，所以先备份
//	strcpy(buf, arr);
//	
//	const char* sep = "@.";
//	char* str = NULL;
...
//	int ret = memcmp(arr1, arr2, 18); //所以对比17个字节都相等
//	printf("%d\n", ret);
//	return 0;
//}
...
//	char name[20];
//	char id[12];
//}ss;//匿名结构体，因为不能再创建新的变量，所以只能用一次


//

//typedef struct Node  //typedef 类型重定义
//{
//	int data; //数据
//	struct Node* next; //指针
//}Node, *pNode;
